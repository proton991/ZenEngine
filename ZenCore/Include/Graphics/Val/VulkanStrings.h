...
{
template <typename T>
inline std::string VkToString(T value) {}
...
template <>
inline std::string VkToString<VkCompositeAlphaFlagBitsKHR>(VkCompositeAlphaFlagBitsKHR compositeAlpha)
{
...
template <>
inline std::string VkToString<VkSurfaceFormatKHR>(VkSurfaceFormatKHR surfaceFormat)
{
    ...
    switch (surfaceFormat.colorSpace)
    {
        case VK_COLORSPACE_SRGB_NONLINEAR_KHR:
            ...
            break;
        default:
            str += "UNKNOWN COLOR SPACE";
    }
    return str;
}

template <>
inline std::string VkToString<VkPresentModeKHR>(VkPresentModeKHR presentMode)
{
    switch (presentMode)
    {
...
template <>
inline std::string VkToString<VkShaderStageFlagBits>(VkShaderStageFlagBits stage)
{
    switch (stage)
    {
