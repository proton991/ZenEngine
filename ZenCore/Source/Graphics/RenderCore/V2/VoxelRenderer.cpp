...
//     if (m_RHI->QueryGPUInfo().supportGeometryShader)
//     {
//         m_pipelineType = VoxelizePipelineType::eGeometry;
//     }
//     else
//     {
//         m_pipelineType = VoxelizePipelineType::eCompute;
//     }
//     m_pipelineType = VoxelizePipelineType::eCompute;
// }
//
...
// }
//
// void VoxelRenderer::PrepareBuffers()
// {
...
// }
//
// void VoxelRenderer::BuildRenderGraph()
// {
//     if (m_pipelineType == VoxelizePipelineType::eGeometry)
//     {
//         BuildRenderGraphGeometry();
//     }
//     else
//     {
//         BuildRenderGraphCompute();
//     }
// }
//
// void VoxelRenderer::BuildRenderGraphGeometry()
// {
...
// }
//
// void VoxelRenderer::BuildRenderGraphCompute()
// {
...
//                 const int workgroupCount = ceil(double(triangleCount) / double(localSize));
//
...
//                 shaderProgram->pushConstantsData.triangleCount  = subMesh->GetIndexCount() / 3;
...
// }
//
// void VoxelRenderer::BuildGraphicsPasses()
// {
...
// }
//
// void VoxelRenderer::BuildComputePasses()
// {
//     // voxelization pass
//     {
//         ComputePassBuilder builder(m_renderDevice);
//         m_computePasses.voxelization = builder.SetShaderProgramName("VoxelizationCompSP").Build();
//     }
// }
//
// void VoxelRenderer::UpdateGraphicsPassResources()
// {
//     // voxelization pass
//     {
...
// }
//
// void VoxelRenderer::UpdateComputePassResources()
// {
//     // voxelization pass
//     {
//         std::vector<ShaderResourceBinding> set0bindings;
...
//             .SetShaderResourceBinding(6, set6bindings)
//             .Update();
//     }
//     // voxel draw pass
//     {
...
// }
//
// void VoxelRenderer::UpdateUniformData()
// {
//     const sg::AABB& sceneBox = m_scene->GetAABB();
//
//     auto axisSize           = sceneBox.GetMax() - sceneBox.GetMin();
//     auto center             = sceneBox.GetCenter();
//     m_config.volumeGridSize = glm::max(axisSize.x, glm::max(axisSize.y, axisSize.z));
//     m_config.voxelSize      = m_config.volumeGridSize / m_config.volumeDimension;
//
//     {
//         auto halfSize = m_config.volumeGridSize / 2.0f;
//         // projection matrices
//         auto projection =
//             glm::ortho(-halfSize, halfSize, -halfSize, halfSize, 0.0f, m_config.volumeGridSize);
//         projection[1][1] *= -1;
//
//         // view matrices
//         VoxelizationProgram* shaderProgram =
...
//             Vec4(sceneBox.GetMin(), 1.0f / m_config.volumeGridSize);
//
//         for (int i = 0; i < 3; ++i)
//         {
...
//         auto modelMatrix = glm::translate(Mat4(1.0f), sceneBox.GetMin()) *
...
//             dynamic_cast<VoxelizationCompProgram*>(m_computePasses.voxelization.shaderProgram);
//
//         shaderProgram->sceneInfo.aabbMax = Vec4(m_scene->GetAABB().GetMax(), 1.0f);
//         shaderProgram->sceneInfo.aabbMin = Vec4(m_scene->GetAABB().GetMin(), 1.0f);
//     }
// }
//
//
// void VoxelRenderer::PrepareRenderWorkload()
// {
//     if (m_rebuildRDG)
//     {
//         BuildRenderGraph();
...
//
//     VoxelizationCompProgram* voxelizationCompProgram =
//         dynamic_cast<VoxelizationCompProgram*>(m_computePasses.voxelization.shaderProgram);
//     voxelizationCompProgram->UpdateUniformBuffer("uSceneInfo",
//                                                  voxelizationCompProgram->GetSceneInfoData(), 0);
//
