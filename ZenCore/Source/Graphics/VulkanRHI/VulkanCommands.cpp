                                                   ...
                                                   RHITextureLayout newLayout)
{
    ...
    VkImageLayout srcLayout = m_pVkRHI->GetImageCurrentLayout(pVkTexture->GetVkImage());
    ...
    ChangeImageLayout(pVkTexture->GetVkImage(), srcLayout, dstLayout,
                      pVkTexture->GetVkSubresourceRange());
}
